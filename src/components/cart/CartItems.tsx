...
export function CartItems() {
  ...
  return (
    <section className="grid w-full gap-8 bg-acid px-5 pb-12 pt-[calc(env(safe-area-inset-top)+6.5rem)] text-ink md:px-8 md:py-16 lg:grid-cols-[1fr_360px] xl:px-12">
