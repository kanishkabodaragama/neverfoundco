        ...
        <div className="grid gap-5">
          {contactItems.map((item) => (
            <div className="grid grid-cols-[44px_1fr] gap-4" key={item.label}>
              <span className="flex h-10 w-10 items-center justify-center border border-ink/30 font-sans text-lg text-rust">
                {item.icon}
              </span>
              <div>
                <p className="font-sans text-[11px] font-bold uppercase tracking-normal text-rust">{item.label}</p>
